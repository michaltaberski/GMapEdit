(function() {
  ...
  _.invoke = function(obj, method) {
    var _i, _len, _ref, _result, args, val;
    args = _.rest(arguments, 2);
    _result = []; _ref = obj;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      val = _ref[_i];
      _result.push((method ? val[method] : val).apply(val, args));
    }
    return _result;
  };
  ...
  _.without = function(array) {
    var _i, _len, _ref, _result, val, values;
    values = _.rest(arguments);
    _result = []; _ref = _.toArray(array);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      val = _ref[_i];
  ...
  _.range = function(start, stop, step) {
    var _result, a, i, idx, len, range, solo;
    a = arguments;
    solo = a.length <= 1;
    i = (start = solo ? 0 : a[0]);
    stop = solo ? a[0] : a[1];
  ...
  _.compose = function() {
    ...
    return function() {
      var args, i;
      args = arguments;
      for (i = funcs.length - 1; (funcs.length - 1 <= 0 ? i <= 0 : i >= 0); i += -1) {
  ...
  _.extend = function(obj) {
    var _i, _len, _ref, _ref2, _result, key, source, val;
    _ref = _.rest(arguments);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      source = _ref[_i];
      obj[key] = (function() {
        _result = []; _ref2 = source;
        for (key in _ref2) {
  ...
  _.isEqual = function(a, b) {
    var _ref, _result, aKeys, atype, bKeys, btype, key, val;
    if (a === b) {
      return true;
    }
    atype = typeof (a);
  ...
  _.times = function(n, iterator, context) {
    ...
    for (i = 0; (0 <= n ? i < n : i > n); (0 <= n ? i += 1 : i -= 1)) {
      _result.push(iterator.call(context, i));
    }
    return _result;
  };
  ...
  _.mixin = function(obj) {
    ...
    _result = []; _ref = _.functions(obj);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      name = _ref[_i];
      _result.push(addToWrapper(name, _[name] = obj[name]));
    }
    return _result;
  };
  idCounter = 0;
